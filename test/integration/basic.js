...
describe('express:app integration test', function () {
  ...
  //   describe('cloudant code tests', function () {
  //     it('contains the cloudant require', function () {
  //       assert.fileContent(common.file.manifest_yml, "- testApp-cloudant-0");
  //     });
  //
  //     it('contains the cloudant declared-service', function () {
  ...
  //
  //   describe('autoScaling code tests', function () {
  //     it('contains the autoScaling require', function () {
  //       assert.fileContent(common.file.manifest_yml, "- testApp-autoScaling");
  //     });
  //
  //     it('contains the autoScaling declared-service', function () {
  //       assert.fileContent(common.file.manifest_yml,
  //           "testApp-autoScaling:" +
  //           "\n      label: Auto-scaling" +
  //           "\n      plan: free");
  ...
  //   it('contains the cf create cloudant command', function () {
  //     assert.fileContent(common.file.pipeline_yml,
  //         "cf create-service cloudantNoSQLDB Lite testApp-cloudant-0");
  //   });
  //
  //   it('contains the cf create autoScaling command', function () {
  //     assert.fileContent(common.file.pipeline_yml,
  //         "cf create-service Auto-Scaling free testApp-autoScaling" +
  //         "\n      sleep 20");
  //   });
  // });
