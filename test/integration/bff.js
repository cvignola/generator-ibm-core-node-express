...
describe('express:app integration test with applicationType BFF', function () {
  ...
  describe(common.file.manifest_yml, function () {
    it('OPENAPI_SPEC does exist', function () {
      assert.fileContent(common.file.manifest_yml, /OPENAPI_SPEC/);
    });
  });
